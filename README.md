...
| `get_issue_changelog` | История изменений задачи (переходы статусов, смена исполнителя и др.). Фильтр по полю |
...
```
get_issue_changelog(issue_id="SUPPORT-123", field="status")
```
